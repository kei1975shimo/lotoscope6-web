...
7. `/health` が `OK` になり、画面下部に `v1.17.0-mystic-oracle` が出ることを確認します。
8. 無料の西洋占星術、くじ5種類、再確認ボタンを操作します。有料の2占術は案内画面へ移動します。同じ条件で1口・3口・10口を比較し、先頭と順番が一致することを確認します。
...
有料機能の提供開始前には `docs/STORE_RELEASE_JA.md` の未実装項目を完了してください。この版には購入機能はありません。
